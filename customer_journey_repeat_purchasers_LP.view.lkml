view: customer_journey_repeat_purchasers_LP {
  derived_table: {
    sql: --Find the average number of repeat purchasers (High Value Customers) by landing page and referring URL
      ...
      --Avg number of repeat purchase by landing page
      with x as (
        --Customer Journey
      ...
      select avg(repeat_purchase) avg_repeat_purchase, a.total_purchases, xcc.landing_page
      from xcc
  ...
  set: detail {
    fields: [avg_repeat_purchase, total_purchases, landing_page]
  }
}
